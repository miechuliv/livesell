<?php
class ControllerShippingpocztapriorytet extends Controller {
	private $error = array(); 
	...
	public function index() {   
 		...
 		if (isset($this->error['warning'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('shipping/pocztapriorytet', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('shipping/pocztapriorytet', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['pocztapriorytet_status'])) {
			$this->data['pocztapriorytet_status'] = $this->request->post['pocztapriorytet_status'];
		} else {
			$this->data['pocztapriorytet_status'] = $this->config->get('pocztapriorytet_status');
		}
		
		if (isset($this->request->post['pocztapriorytet_sort_order'])) {
			$this->data['pocztapriorytet_sort_order'] = $this->request->post['pocztapriorytet_sort_order'];
		} else {
			$this->data['pocztapriorytet_sort_order'] = $this->config->get('pocztapriorytet_sort_order');
		}				
		...
		$this->template = 'shipping/pocztapriorytet.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
